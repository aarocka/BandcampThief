...
function downloadSong(track, albumId) {
		...
		helper.getBandInfo(albumInfo.band_id, function(bandInfo, error) {
			...
			req.on('response', function(res) {
				...
				res.on('end', function() {
					...
					request.post("https://api.prowlapp.com/publicapi/add?apikey=8365a3833fc87d193807c2fda83f931a4f7a2d49&application=BandcampThief&description=" + t.title + " finished");
				});
			});
			req.pipe(output);
		});
